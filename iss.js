...
const nextISSTimesForMyLocation = function(callback) {
  fetchMyIP((error, ip) => {
    if (error) {
      console.log("It didn't work! Couldn't get IP:" , error);
      ...
      fetchCoordsByIp(ip, (error, coords) => {
        if (error) {
          console.log("It didn't work! Couldn't get COORDS:" , error);
          return;
        } else {
          ...
          fetchISSFlyoverTimes(coords, (error, data) => {
            if (error) {
              console.log("It didn't work! Couldn't get flyover times:" , error);
              return;
            } else {
              console.log('It worked! Returned flyover data:' , data);
